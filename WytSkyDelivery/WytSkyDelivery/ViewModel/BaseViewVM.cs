...
{
    public class BaseViewVM : BaseViewModel
    {
        ...
        private ModelDto.ErpPages _Model;
        ...
        public ModelDto.ErpPages Model
        {
            get => _Model;
        ...
        public BaseViewVM(ModelDto.ErpPages model)
        {
            try
            {
                Model = model;
            ...
            catch (Exception ex)
            {
                ...
                ExtensionLogMethods.LogExtension(ExceptionMseeage, "", "BaseViewVM", "Constructor");
            }
        }
        ...
        public async void GetData()
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        var res = await Api.ServiceApp.GetAll(Model.PathName);
                        if (res == null)
                        {
        ...
        private async System.Threading.Tasks.ValueTask SelectedItem(ModelDto.ListPageData model)
        {
            try
            {
                ...
                //else
                //{ 
                //    var res = await APIs.ServiceTechnicalNotification.Update(new Dictionary<string, string>()
                //    {
                //        {"ClientNotificationID", model.ClientNotificationID + "" },
                //        {"IsRead", "true" },
                //    });
                //    if (res != null)
                //    {
